<?php
session_start();
include('ProyectoWeb2/conexion.php');
if(isset($_SESSION['usuarioingresando']))
{
	header('location: ProyectoWeb2/principal.php');
}
?>
...
<link rel="stylesheet" href="ProyectoWeb2/CSS/style.css">
</head>
<body>
...
<div>
<a href="ProyectoWeb2/usuarios_registrar.php" class="BtnRegistrar">Crea nueva cuenta</a>
</div>
